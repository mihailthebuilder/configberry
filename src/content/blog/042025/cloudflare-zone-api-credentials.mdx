...
If you're looking for a quick way to copy Cloudflare WAF security rules across multiple domains - check out the [WAF Sync Tool](/waf-sync) on this site. All you need are the API credentials for the zones where you want to perform the copy / paste. Read [this blog post](./copy-cloudflare-waf-rules) to see how it works.
